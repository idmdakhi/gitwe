...
export function registerCommitLintCommand(
  ...
  program
    ...
    .description("Validate a commit message against the workflow's Conventional Commits policy (default: HEAD)")
    .action(async (ref: string | undefined) => {
      ...
      try {
        ...
        const result = { ref: ref ?? "HEAD", message: commit.message, valid: !violation, reason: violation };
