...
//   branchRenames: Record<string, string>,
//   prefixOverrides: Record<string, string>,
//   remoteName?: string,
// ): WorkflowConfig {
//   let next = config;

//   if (Object.keys(branchRenames).length > 0) {
//     const renameMap = new Map(Object.entries(branchRenames));
...
//   if (Object.keys(prefixOverrides).length > 0) {
//     const types = next.branchTypes.map((t) => {
//       const p = prefixOverrides[t.name];
