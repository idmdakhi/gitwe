import { assertValidBranchName, globToRegExp } from "../core/branchName.js";
import { OperationStateError, ValidationError } from "../core/errors.js";
import type { Logger } from "../core/logger.js";
import { silentLogger } from "../core/logger.js";
import type { BranchStatus, ResolvedTopic, TopicType, WorkflowConfig } from "../core/types.js";
...
import { FinishOperation, type FinishOptions, type FinishResult } from "./operations/finish.js";
import { OperationStateStore } from "./state.js";
...
export class Engine {
  ...
  constructor(options: EngineOptions) {
    ...
    this.ctx = {
      ...
      root: options.root,
      logger,
      hooks: new HookRunner(options.root, options.config.hooks, logger),
  ...
  static async create(options: {
    ...
    await engine.initStateStore();
    return engine;
  }

  private async initStateStore(): Promise<void> {
    this.ctx.state = new OperationStateStore(await this.git.gitDir());
  }
